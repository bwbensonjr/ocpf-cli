...
Establish the shared foundation for the `ocpf` command-line tool: the top-level
command entry point, a reusable OCPF REST API client, human-readable and
machine-readable output modes, and consistent error reporting and exit codes.
